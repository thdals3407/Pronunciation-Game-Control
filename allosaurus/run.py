...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--lang', type=str,  default='kor',help='specify which language inventory to use for recognition. default is to use all phone inventory')
    ...
    parser.add_argument('-t', '--timestamp', type=bool, default=True, help='attach *approximate* timestamp for each phone, note that the timestamp might not be accurate')
