...
def read_audio(filename, header_only=False, channel=0):
    ...
    # print("Check_wf_nChannels", wf.getnchannels())
    # check the input channel is valid
    assert channel < channel_number
    # print("Check_wf_framerate", wf.getframerate())
    # print("Check_wf_nframes", wf.getnframes())
    # print("Check_wf_sampwidth", wf.getsampwidth())
    # set wav header
